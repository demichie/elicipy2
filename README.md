...
Then, activate the environment and download a [copy]([https://website-name.com](https://github.com/demichie/elicipy2/archive/refs/heads/main.zip 'zip') of the repository.
